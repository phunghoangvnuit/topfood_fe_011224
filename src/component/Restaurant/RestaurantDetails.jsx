  ...
  return (
    <div className="px-5 lg:px-20">
      <section>
        ...
        <div className="pt-3 pb-5 text-black">
      ...
      <Divider sx={{ backgroundColor: "#ed1b24" }} />
      <section className="pt-[2rem] lg:flex relative">
        <div className="space-y-10 lg:w-[20%] filter">
          <div className="box space-y-5 lg:sticky top-28">
            <div>
              <Typography variant="h5" sx={{ paddingBottom: "1rem", color: "#ed1b24" }}>
                Food Type
              </Typography>
              ...
              <FormControl className="py-10 space-y-5" component={"fieldset"}>
                ...
                >
                  {foodTypes
                    .filter((item) => item.value !== "seasonal")
                    .map((item) => (
                      <FormControlLabel
                        key={item.value}
                        value={item.value}
                        control={<Radio sx={{ color: "#ed1b24", '&.Mui-checked': { color: "#ed1b24" } }} />}
                        label={item.label}
                        style={{ color: "black" }}
                      />
                    ))}
