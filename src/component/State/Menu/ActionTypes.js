...
export const GET_MENU_ITEMS_BY_RESTAURANT_ID_FAILURE = 
  ...
  export const UPDATE_MENU_ITEMS_AVAILABILITY_REQUEST = "UPDATE_MENU_ITEM_AVAILABILITY_REQUEST";
  export const UPDATE_MENU_ITEMS_AVAILABILITY_SUCCESS = "UPDATE_MENU_ITEM_AVAILABILITY_SUCCESS";
  export const UPDATE_MENU_ITEMS_AVAILABILITY_FAILURE = "UPDATE_MENU_ITEM_AVAILABILITY_FAILURE";
